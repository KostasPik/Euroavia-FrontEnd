  ...
  return (
    <section className="section departments">
        ...
        <div className="row1-container">
                <div className="card-box box-down cyan electrical-design">
                ...
                <div className="card-box box-down blue aerodynamics">
                  <h2>Aerodynamics</h2>
...
{/* NEW */}
              ...
              <div className="row1-container">
                <div className="card-box box-up cyan event-organising">
                ...
                <div className="card-box box-up blue creative-design">
